 ...
 */
package feign.remoting.dispatcher;
...
public class DispatcherHandler extends ChannelInboundHandlerAdapter {
    ...
    public DispatcherHandler(ConcurrentHashMap<String, UserProcessor<?>> userProcessors) {
        serverSide = false;
        this.userProcessors = userProcessors;
    }

    public DispatcherHandler(boolean serverSide, ConcurrentHashMap<String, UserProcessor<?>> userProcessors) {
