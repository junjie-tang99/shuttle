package feign.remoting.connection.handler;
...
import feign.remoting.connection.manager.ConnectionManager;
...
public class ConnectionEventHandler extends ChannelDuplexHandler {
    ...
    public void userEventTriggered(ChannelHandlerContext ctx, Object event) throws Exception {
    	//如果发送的事件是ConnectionEventType（Enum类型）
    ...
    public class ConnectionEventExecutor {
        Logger logger = LoggerFactory.getLogger("ConnectionEventExecutor");
